...
<h1><font size="10">⚙️ Work Flow:</font></h1>

 <h1>ACTIVE MODE:</h1>The system encodes student facial features into vectors and saves these encodings for accurate face matching during the face scanning.
<br>
<h1>ENCODING:</h1>
